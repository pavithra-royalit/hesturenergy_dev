        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand mt-5" href="<?php echo base_url(); ?>">
                        <!-- Logo text --><span>
                         ...
                         <!-- Light Logo text -->   
                         </span> <span class="fs-3 fw-bold text-white">Hestur</span></a>
                </div>
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url(); ?>assets/images/users/userav-min.png" alt="Genit" class="profile-pic" style="height:40px;width:40px;border-radius:50px" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="<?php echo base_url(); ?>assets/images/users/userav-min.png" alt="user"></div>
                                            <div class="u-text">
                                    ...
                                    <?php } else { ?>
                                    <li><a href="<?php echo base_url(); ?>dealer/logout"><i class="fa fa-power-off"></i> Logout</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </li>
