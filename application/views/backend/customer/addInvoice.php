                         ...
                         <!--job card code start -->
                              <div class="tab-pane active" id="invoice" role="tabpanel">
                                ...
                                <div class="col-md-1"></div>
                                      <div class="col-md-10">
                                      <div class="card">
                                           <a href="<?php echo base_url(); ?>customer/invoiceview?I=<?php echo base64_encode($basic->id) ?>" title="Edit"  class="btn btn-sm btn-info waves-effect waves-light mt-3" style="width:150px;margin-left:10px;"><i class="fa fa-pencil-square-o"></i> List of Invoice</a>
                                      <div class="card-body">
                                         <h4 class="text-center p-b-3" style="color:#13637c">Add Invoice: </h4>
