                    ...
                    <div class="col-12 col-md-4 col-lg-3">
                        <div class="card">
                            ...
                            <ul class="nav nav-pills p-3 profile-tab flex-column" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab" style="font-size: 14px;">   Customer Info </a> </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#document" role="tab" style="font-size: 14px;">POS</a> </li>
                                ...
                                <div class="card">
			                        <div class="card-body">
                                       ...
                                       <div class="col-md-6 m-b-5">           
                                           <h6>  <small class="text-muted">Customer Name </small>: <?php echo $basic->name; ?></h6> 
                                        </div>
                                        <div class="col-md-6 m-b-5">
                                                
                                           <h6><small class="text-muted">Phone</small> : <?php echo $basic->phone; ?></h6> 
                                        </div>
                                        <div class="col-md-6 m-b-5">
                                        <h6> <small class="text-muted">Email address </small> : <?php echo $basic->email; ?></h6> 
                                        </div>
                                        <div class="col-md-6 m-b-5">
                                          <h6> <small class="text-muted ">State</small> : <?php echo $basic->state; ?></h6> 
                                        </div>
                                        <div class="col-md-6 m-b-5">
                                            <h6> <small class="text-muted">City </small> : <?php echo $basic->city; ?></h6> 
                                        </div>
                                        <div class="col-md-6 m-b-5">
                                           <h6>  <small class="text-muted ">Zip Code</small> : <?php echo $basic->zip; ?></h6> 
                                        </div>
                                        <div class="col-md-6 m-b-5">
                                            <h6> <small class="text-muted ">Year</small> : <?php echo $basic->year; ?></h6> 
                                        </div>
                                        <div class="col-md-6 m-b-5">
                                           <h6> <small class="text-muted ">Model</small> : <?php echo $basic->model; ?></h6> 
                                        </div>
                                        <div class="col-md-6 m-b-5">
                                        ...
                                        <div class="col-md-6 m-b-5">
                                           <h6> <small class="text-muted ">Address</small> : <?php echo $basic->address; ?></h6> 
                                            ...
                                            <!--<div class="col-md-8">
                                            <div class="card-body">
                                            <h4 class="text-center p-b-10" style="color:#13637c">Add Po's Quotation: </h4>
                                     <hr>
                                      <form class="row" action="Add_POS" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card card-body">
                        ...
                        <div class="row " style="background:#13637c; margin:15px 0px 15px 0px">
                            <div class="col-md-12 text-left">
                                <h4 style="margin-top: 15px;color:#fff; text-align:center">PURCHASE ORDER  #<?php echo $basic->po_code; ?></h4>
                            </div>
                        </div>
