                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                         ...
                                         <tbody>
                                               ...
                                               <a href="<?php echo base_url(); ?>customer/edit_jobcard?I=<?php echo base64_encode($value->cid) ?>&id=<?php echo $value->job_code ?>" title="Edit"  class="btn btn-sm btn-primary waves-effect waves-light " "><i class="fa fa-pencil-square-o"></i></a>
                                                <?php if($status == "Completed"){ ?>
                                                 <a href="<?php echo base_url(); ?>customer/jobcard_invoice?I=<?php echo base64_encode($value->cid) ?>&id=<?php echo $value->job_code ?>" title="Invoice"  class="btn btn-sm btn-warning waves-effect waves-light " "><i class="fa fa-eye"></i></a>
                                                 <a href="<?php echo base_url(); ?>customer/gatepass?I=<?php echo base64_encode($value->cid) ?>&id=<?php echo $value->job_code ?>" title="Gate Pass"  class="btn btn-sm btn-info waves-effect waves-light " "><i class="fa fa-file"></i></a>
                                              <?php } ?>
